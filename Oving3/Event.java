 ...
 * types of events are described in the HogaBoga.Constants interface.
 * @see Oving3.EventQueue
 * @see Oving3.Constants
 */
public class Event implements Comparable
{
	 ...
	 * @param type	The type of event, as defined in the HogaBoga.Constants interface.
	 ...
	 * the list of events maintained by the HogaBoga.EventQueue class.
    ...
    public String toString() {
        return "HogaBoga.Event{" + "type=" + type + ", time=" + time + '}';
    }
